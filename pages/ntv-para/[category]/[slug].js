...
export async function getStaticProps(context) {
	...
	const response = await fetch(
		`${process.env.NEXT_PUBLIC_API}/ntv-para/${params.category}/${params.slug}`,
		{
			method: "GET",
			headers: {
